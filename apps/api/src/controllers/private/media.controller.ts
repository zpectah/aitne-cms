...
const deleteSelectedMedia = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { ids } = req.body;
...
const toggleMedia = async (req: Request, res: Response, next: NextFunction) => {
  const id = parseInt(req.params.id, 10);
...
const toggleSelectedMedia = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { ids } = req.body;
