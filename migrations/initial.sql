...
CREATE TABLE `cms_comments` (
  `id` int NOT NULL AUTO_INCREMENT,
  `origin_type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `cms_media` (
  ...
  `name` text COLLATE utf8mb4_general_ci NOT NULL,
  `type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `mime` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `cms_pages` (
  ...
  `name` text COLLATE utf8mb4_general_ci NOT NULL,
  `type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `categories` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `created` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `active` int NOT NULL,
  `deleted` int NOT NULL,
...
-- Dump completed on 2024-09-29 19:46:36
